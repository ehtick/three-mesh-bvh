import{At as e,Bt as t,Et as n,F as r,I as i,Ot as a,S as o,Ur as s,Y as c,dr as l,fr as u,i as d,nt as f,rn as p,x as m}from"./ExtendedTriangle-cvTTtm2k.js";import{t as h}from"./MeshBVH-BCJSiupA.js";import{t as g}from"./MeshBVHUniformStruct-CsEKwaR-.js";import{n as _,r as v,t as y}from"./bvh_struct_definitions.glsl-D-uzwxra.js";import{t as b}from"./lil-gui.module.min-CCk8J1jY.js";import{t as x}from"./GLTFLoader-k9Ro4ZOw.js";import{t as S}from"./OrbitControls-CZExYGpc.js";import{t as C}from"./stats.module-BDErWxYO.js";var w=class extends r{constructor(e){super(e),this.type=f}parse(e){let t=function(e,t){switch(e){case 1:throw Error(`THREE.HDRLoader: Read Error: `+(t||``));case 2:throw Error(`THREE.HDRLoader: Write Error: `+(t||``));case 3:throw Error(`THREE.HDRLoader: Bad File Format: `+(t||``));default:case 4:throw Error(`THREE.HDRLoader: Memory Error: `+(t||``))}},n=function(e,t,n){t||=1024;let r=e.pos,i=-1,a=0,o=``,s=String.fromCharCode.apply(null,new Uint16Array(e.subarray(r,r+128)));for(;0>(i=s.indexOf(`
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},a=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},s=function(e,t,n,r){let a=2**(e[t+3]-128)/255;n[r+0]=i.toHalfFloat(Math.min(e[t+0]*a,65504)),n[r+1]=i.toHalfFloat(Math.min(e[t+1]*a,65504)),n[r+2]=i.toHalfFloat(Math.min(e[t+2]*a,65504)),n[r+3]=i.toHalfFloat(1)},l=new Uint8Array(e);l.pos=0;let u=r(l),d=u.width,p=u.height,m=a(l.subarray(l.pos),d,p),h,g,_;switch(this.type){case c:_=m.length/4;let e=new Float32Array(_*4);for(let t=0;t<_;t++)o(m,t*4,e,t*4);h=e,g=c;break;case f:_=m.length/4;let t=new Uint16Array(_*4);for(let e=0;e<_;e++)s(m,e*4,t,e*4);h=t,g=f;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:d,height:p,data:h,header:u.string,gamma:u.gamma,exposure:u.exposure,type:g}}setDataType(e){return this.type=e,this}load(t,r,i,a){function o(t,i){switch(t.type){case c:case f:t.colorSpace=e,t.minFilter=n,t.magFilter=n,t.generateMipmaps=!1,t.flipY=!0;break}r&&r(t,i)}return super.load(t,o,i,a)}},T=class extends w{constructor(e){console.warn(`RGBELoader has been deprecated. Please use HDRLoader instead.`),super(e)}},E,D,O,k,A,j,M,N,P,F={color:`#ffffff`,bounces:3,ior:2.4,aberrationStrength:.01,fastChroma:!1,animate:!0};I();async function I(){E=new l,D=new p(75,window.innerWidth/window.innerHeight,.1,1e3),D.position.set(28,15,7),O=new d({antialias:!1}),O.setSize(window.innerWidth,window.innerHeight),O.toneMapping=4,O.setAnimationLoop(L),document.body.appendChild(O.domElement),A=new S(D,O.domElement),P=new m;let e=new T().loadAsync(`https://raw.githubusercontent.com/mrdoob/three.js/dev/examples/textures/equirectangular/venice_sunset_1k.hdr`),r=new x().loadAsync(`https://raw.githubusercontent.com/gkjohnson/3d-demo-data/main/models/diamond/diamond.glb`),i;[k,i]=await Promise.all([e,r]),k.mapping=303,k.generateMipmaps=!0,k.minFilter=a,k.magFilter=n,E.background=k;let c=new u({uniforms:{envMap:{value:k},bvh:{value:new g},projectionMatrixInv:{value:D.projectionMatrixInverse},viewMatrixInv:{value:D.matrixWorld},resolution:{value:new s},bounces:{value:3},ior:{value:2.4},color:{value:new o(1,1,1)},fastChroma:{value:!1},aberrationStrength:{value:.01}},vertexShader:`
