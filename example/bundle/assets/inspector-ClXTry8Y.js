import{Bt as e,Qn as t,S as n,Tt as r,Ur as i,Vt as a,Wr as o,Xn as s,Y as c,Yr as l,_ as u,dr as d,fr as f,i as p,rn as m}from"./ExtendedTriangle-cvTTtm2k.js";import{t as h}from"./Pass-BZUemdGI.js";import{t as g}from"./BVHHelper-Du2Ihw_0.js";import{n as _,t as v}from"./Debug-oESVmGGn.js";import{a as y,r as b,t as x}from"./ExtensionUtilities-CU3aW_1y.js";import{t as S}from"./lil-gui.module.min-CCk8J1jY.js";import{t as C}from"./GLTFLoader-k9Ro4ZOw.js";import{t as w}from"./OrbitControls-CZExYGpc.js";e.prototype.raycast=x,u.prototype.computeBoundsTree=b,u.prototype.disposeBoundsTree=y;var T,E,D,O,k,A,j,M,N,P,F=new i,I=new Float32Array(1),L=`https://raw.githubusercontent.com/gkjohnson/3d-demo-data/main/models/dragon-attenuation/DragonAttenuation.glb`,R={options:{strategy:2,maxLeafSize:10,maxDepth:40,rebuild:function(){G()}},visualization:{displayMesh:!0,simpleColors:!1,outline:!0,traversalThreshold:50},benchmark:{displayRays:!1,firstHitOnly:!0,rotations:10,castCount:1e3}},z=new n(16770670).convertLinearToSRGB().getHex(),B=25453,V=16081063,H=class extends f{constructor(e){super({uniforms:{map:{value:null},threshold:{value:35},boundsColor:{value:new n(16777215)},backgroundColor:{value:new n(0)},thresholdColor:{value:new n(16711680)},resolution:{value:new i},outlineAlpha:{value:.5}},vertexShader:`
				varying vec2 vUv;
				void main() {
